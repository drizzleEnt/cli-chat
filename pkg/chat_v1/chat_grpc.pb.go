...
func (c *chatV1Client) SendMessage(ctx context.Context, in *SendRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedChatV1Server) SendMessage(context.Context, *SendRequest) (*empty.Empty, error) {
